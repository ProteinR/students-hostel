...
//    $query = 'SELECT * FROM students WHERE id=:id';
    $studObj = $pdo->prepare('SELECT * FROM students WHERE id=:id'); //объект с рез-том запроса
    $studObj->bindParam(':id', $id, PDO::PARAM_INT);
    $studObj->execute();

    $studArr = $studObj->fetchAll(PDO::FETCH_ASSOC);
    $studArr = $studArr[0];
                ...
                <div class="card-body">
                    <form name="sutent-data" method="post" action="" class="" >
                        ...
                        <div class="md-form">
                            ...
                            <input type="text" class="form-control" name="fio" id="form11" value="<?= $studArr['fio']?>">
                        ...
                        <div class="md-form">
                            <i class="fa fa-user prefix grey-text"></i>
                            <input type="text" class="form-control" name="block" id="form9" value="<?= $studArr['block']?>">
                            <label for="form9">Корпус (A,B,C)</label>
                        </div>
                        <div class="md-form">
                            <i class="fa fa-user prefix grey-text"></i>
                            <input type="text" class="form-control" name="passport" id="form8" value="<?= $studArr['passport']?>">
...
<!--                        </div>-->
                        ...
                        <div class="md-form">
                            <i class="fa fa-user prefix grey-text"></i>
                            <input type="text" class="form-control" name="course" id="form6" value="<?= $studArr['course']?>">
                            <label for="form6">Курс</label>
                        </div>
                        <div class="md-form">
                            <i class="fa fa-user prefix grey-text"></i>
                            <input type="text" class="form-control" name="group_number" id="form5" value="<?= $studArr['group_number']?>">
                            <label for="form5">Группа</label>
                        </div>
                        <div class="md-form">
                            <i class="fa fa-table prefix grey-text"></i>
                            <input type="text" class="form-control" name="room_id" id="form4" value="<?= $studArr['room_id']?>" >
                            <label for="form4">Комната (id)</label>
                        </div>
                        <div class="md-form">
                            <i class="fa fa-phone prefix grey-text"></i>
                            <input type="text" id="form3" name="personal_phone" class="form-control" value="<?= $studArr['personal_phone']?>">
                            <label for="form3">Телефон</label>
                        </div>
                        <div class="md-form">
                            <i class="fa fa-phone prefix grey-text"></i>
                            <input type="text" class="form-control" name="parents_phone" id="form2" value="<?= $studArr['parents_phone']?>">
                            <label for="form2">Телефон родителей</label>
                        </div>
                        <div class="md-form">
                            <i class="fa fa-home prefix grey-text"></i>
                            <input type="text" class="form-control" name="home_address" id="form1" value="<?= $studArr['home_address']?>">
